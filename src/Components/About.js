    ...
    (
        ...
        <div className="container">
            <header className="section-header">
                <h3>About Me</h3>
                <p>A software developer with over 10+ years of experience in all phases of the software development life cycle (SDLC), specializing in conceptualizing business needs and translating them into viable technical solutions.<br/>
Strengths include strong analytical skills, problem-solving abilities, team collaboration, rapid adaptation to new technologies, and a proven track record of development experience.</p>
            </header>
                ...
                <div className="col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div className="about-col">
                        ...
                        <p>
                            ...
                            planning to do <strong>Professional Developer Plus Certification </strong><img className="pro_dev"
                                                                                          src="img/pro-dev-plus-2x.png"/>
                            very soon.
                        </p>
                    </div>
                </div>
